...
- Publish each package to the repository and public root registered for its concept: Editorial Proof uses `wallymo/wallymo.github.io` at `https://wallymo.github.io/`; Proof Grid uses `wallymostafa/wallymostafa.github.io` at `https://wallymostafa.github.io/`. The generated resume, cover letter, Open Graph metadata, manifest, checker, and verifier must all use that same concept-specific root.
