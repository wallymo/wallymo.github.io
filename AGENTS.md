...
- Write tailored-route hero intros in first person. On showcase routes, connect the employer's specific problem to two or three selected pieces of work and the experience established by the resume. Keep the paragraph concise and grounded; full routes may explain fit more directly. Never use third-person candidate-summary copy (`Wally`, `he`, `him`, or `his`).
...
- On a showcase route, use the hero to explain why this work was selected. Name the role's real product or client challenge, identify the relevant experience already established by the resume, and point to specific proof in the selected projects. Keep it short enough to scan and avoid generic lines such as "these projects may be relevant" or "my resume has the broader context." Do not repeat the full resume argument or claim experience the projects cannot show. On an explicitly `full` route, the hero may make a fuller fit argument using grounded employer language and proof.
