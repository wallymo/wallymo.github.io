...
- If the human explicitly asks to restore How I Build, capabilities, or the career arc on a showcase route, use `route.showcaseSections` to add only the requested canonical section instead of switching the whole route to `full` presentation.
